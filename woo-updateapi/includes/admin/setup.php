...
namespace WooUpdateapi\Admin;

/**
 * WooUpdateapi Setup Class
 */
class Setup {
	/**
	 * Constructor.
	...
	public function register_scripts() {
		...
		wp_enqueue_script( 'woo-updateapi' );
		wp_enqueue_style( 'woo-updateapi' );
	}
	...
	public function register_page() {
		...
		wc_admin_register_page(
			array(
				'id'     => 'woo_updateapi-example-page',
				'title'  => __( 'Woo Updateapi', 'woo_updateapi' ),
				'parent' => 'woocommerce',
				'path'   => '/woo-updateapi',
			)
		);
