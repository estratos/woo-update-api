...
const crc32_1 = tslib_1.__importDefault(require("crc32"));
const debug_1 = tslib_1.__importDefault(require("debug"));
const seed_random_1 = tslib_1.__importDefault(require("seed-random"));
const debug = (0, debug_1.default)('photon');
/**
...
function serverFromUrlParts(pathname, isSecure) {
    ...
    const hash = (0, crc32_1.default)(pathname);
    const rng = (0, seed_random_1.default)(hash);
