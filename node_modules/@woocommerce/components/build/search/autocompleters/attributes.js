...
exports.default = {
    ...
    getFreeTextOptions(query) {
        const label = ((0, element_1.createElement)("span", { key: "name", className: "woocommerce-search__result-name" }, (0, interpolate_components_1.default)({
            mixedString: (0, i18n_1.__)('All attributes with names that include {{query /}}', 'woocommerce'),
            components: {
    ...
    getOptionLabel(attribute, query) {
        ...
        return ((0, element_1.createElement)("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": attribute.name },
