...
exports.drawYAxis = exports.getYGrids = void 0;
/**
...
exports.getYGrids = getYGrids;
const drawYAxis = (node, scales, formats, margin, isRTL) => {
    const yGrids = (0, exports.getYGrids)(scales.yScale.domain()[0], scales.yScale.domain()[1], scales.step);
    ...
    node.append('g')
        ...
        .call((0, d3_axis_1.axisLeft)(scales.yScale)
        .tickValues(yGrids)
    ...
    node.append('g')
        ...
        .call((0, d3_axis_1.axisLeft)(scales.yScale)
        .tickValues(scales.yMax === 0 && scales.yMin === 0
        ? [yGrids[0]]
        : yGrids)
        .tickFormat((d) => {
