...
const Tags = ({ tags = [], disabled, maxVisibleTags = 0, onChange = () => { }, }) => {
    ...
    return ((0, element_1.createElement)("div", { className: "woocommerce-tree-select-control__tags" },
        visibleTags.map((item, i) => {
            ...
            (0, i18n_1.__)('%1$s (%2$d of %3$d)', 'woocommerce'), item.label, i + 1, tags.length);
        ...
        maxTags > 0 && tags.length > maxTags && ((0, element_1.createElement)(components_1.Button, { isTertiary: true, className: "woocommerce-tree-select-control__show-more", onClick: () => {
                setShowAll(!showAll);
            } }, showAll
            ? (0, i18n_1.__)('Show less', 'woocommerce')
            : (0, i18n_1.sprintf)(
            // translators: %d: The number of extra tags to show
            (0, i18n_1.__)('+ %d more', 'woocommerce'), tags.length - maxTags)))));
};
