/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** css ../../../node_modules/.pnpm/css-loader@3.6.0_webpack@5.70.0/node_modules/css-loader/dist/cjs.js!../../../node_modules/.pnpm/postcss-loader@3.0.0/node_modules/postcss-loader/src/index.js??ruleSet[1].rules[0].use[2]!../../../node_modules/.pnpm/sass-loader@10.2.1_sass@1.49.9+webpack@5.70.0/node_modules/sass-loader/dist/cjs.js??ruleSet[1].rules[0].use[3]!./src/style.scss ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
@charset "UTF-8";
/**
 * Colors
...
.woocommerce-legend.woocommerce-legend__direction-row {
  flex-grow: 1;
  flex-direction: row;
}
...
.woocommerce-ellipsis-menu__popover .woocommerce-ellipsis-menu__content .components-button {
  justify-content: center;
  width: 100%;
}
...
.woocommerce-filters-advanced .components-card__header div {
  display: flex;
  line-height: 38px;
}
@media (max-width: 782px) {
...
.woocommerce-select-control.is-searchable .woocommerce-select-control__control-input {
  padding-left: 12px;
}
...
.woocommerce-spinner__circle {
  ...
  -webkit-animation: growAndShrink 2s ease-in-out infinite;
...
.woocommerce-summary__item .woocommerce-summary__info-tooltip {
  color: #949494;
  line-height: 1em;
  margin-left: 4px;
}
.woocommerce-summary__item .woocommerce-summary__info-tooltip svg {
  fill: currentColor;
}
...
.woocommerce-table__summary-item .is-placeholder {
  -webkit-animation: loading-fade 1.6s ease-in-out infinite;
          animation: loading-fade 1.6s ease-in-out infinite;
  background-color: #f0f0f0;
  color: transparent;
...
.woocommerce-table__summary-item .is-placeholder::after {
  content: " ";
}
@media screen and (prefers-reduced-motion: reduce) {
  .woocommerce-table__summary-item .is-placeholder {
...
.muriel-input-text.disabled input::-moz-placeholder {
...
.woocommerce-tour-kit .woocommerce-tour-kit-step {
  width: 350px;
  padding-bottom: 4px;
}
.woocommerce-tour-kit .woocommerce-tour-kit-step__body {
  padding-top: 0;
  padding-bottom: 8px;
}
...
.woocommerce-tour-kit .components-card-header {
  padding-bottom: 0;
}
.woocommerce-tour-kit .woocommerce-tour-kit-step-controls__close-btn {
  height: 16px;
  min-width: 16px;
  padding: 0;
}
.woocommerce-tour-kit .woocommerce-tour-kit-step-controls__close-btn svg {
  fill: #1e1e1e;
}
.woocommerce-tour-kit .woocommerce-tour-kit-step-navigation {
  display: flex;
  align-items: center;
  justify-content: space-between;
  width: 100%;
}
.woocommerce-tour-kit .woocommerce-tour-kit-step-navigation button {
  margin-left: 16px;
}
...
.woocommerce-tour-kit .tour-kit-frame__arrow, .woocommerce-tour-kit .tour-kit-frame__arrow::before {
  z-index: 1;
}

.woocommerce-collapsible-content .woocommerce-collapsible-content__toggle {
  all: unset;
  font-size: 13px;
  color: #007CBA;
  cursor: pointer;
}
.woocommerce-collapsible-content .woocommerce-collapsible-content__toggle > div {
  display: flex;
  align-items: center;
}
.woocommerce-collapsible-content .woocommerce-collapsible-content__toggle svg {
  fill: #007CBA;
  margin-left: 2px;
}
