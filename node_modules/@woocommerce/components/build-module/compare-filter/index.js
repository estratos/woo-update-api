...
export class CompareFilter extends Component {
    ...
    render() {
        ...
        const { selected } = this.state;
        return (createElement(Card, { className: "woocommerce-filters__compare" },
            ...
            createElement(CardFooter, { justify: "flex-start" },
                ...
                selected.length > 0 && (createElement(Button, { isLink: true, onClick: this.clearQuery }, __('Clear all', 'woocommerce'))))));
    }
}
