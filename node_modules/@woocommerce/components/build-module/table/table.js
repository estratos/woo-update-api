...
class Table extends Component {
    ...
    render() {
        ...
        return (createElement("div", { className: classes, ref: this.container, tabIndex: tabIndex, "aria-hidden": ariaHidden, "aria-labelledby": `caption-${instanceId}`, role: "group", onScroll: this.updateTableShadow },
            createElement("table", null,
                createElement("caption", { id: `caption-${instanceId}`, className: "woocommerce-table__caption screen-reader-text" },
                    caption,
                    tabIndex === '0' && (createElement("small", null, __('(scroll to see more)', 'woocommerce')))),
                createElement("tbody", null,
                    createElement("tr", null, headers.map((header, i) => {
                        ...
                        const iconLabel = sortedBy === key && sortDir !== ASC
                            ? sprintf(__('Sort by %s in ascending order', 'woocommerce'), screenReaderLabel || label)
                            : sprintf(__('Sort by %s in descending order', 'woocommerce'), screenReaderLabel || label);
                    ...
                    hasData ? (rows.map((row, i) => (createElement("tr", { key: this.getRowKey(row, i) }, row.map((cell, j) => {
                        ...
                        return (createElement(Cell, { scope: isHeader ? 'row' : null, key: cellKey, className: cellClasses }, getDisplay(cell)));
                    }))))) : (createElement("tr", null,
                        createElement("td", { className: "woocommerce-table__empty-item", colSpan: headers.length }, __('No data to display', 'woocommerce'))))))));
    }
}
Table.propTypes = {
    /**
