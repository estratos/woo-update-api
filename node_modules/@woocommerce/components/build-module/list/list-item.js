...
function ListItem(props) {
    ...
    return (createElement(InnerTag, { ...innerTagProps },
        before && (createElement("div", { className: "woocommerce-list__item-before" }, before)),
        createElement("div", { className: "woocommerce-list__item-text" },
            createElement("span", { className: "woocommerce-list__item-title" }, title),
            content && (createElement("span", { className: "woocommerce-list__item-content" }, content))),
        after && (createElement("div", { className: "woocommerce-list__item-after" }, after))));
}
ListItem.propTypes = {
    /**
