...
class MenuItem extends Component {
    ...
    render() {
        ...
        if (isCheckbox) {
            return (createElement("div", { "aria-checked": checked, ref: this.container, role: "menuitemcheckbox", tabIndex: "0", onKeyDown: this.onKeyDown, onClick: this.onClick, className: "woocommerce-ellipsis-menu__item" },
                createElement(BaseControl, { className: "components-toggle-control" },
                    createElement(FormToggle, { "aria-hidden": "true", checked: checked, onChange: this.props.onInvoke, onFocus: this.onFocusFormToggle, onClick: (e) => e.stopPropagation(), tabIndex: "-1" }),
                    children)));
        }
        return (createElement("div", { role: "menuitem", tabIndex: "0", onKeyDown: this.onKeyDown, onClick: this.onClick, className: "woocommerce-ellipsis-menu__item" }, children));
    }
}
MenuItem.propTypes = {
    /**
