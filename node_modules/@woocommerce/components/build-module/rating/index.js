...
class Rating extends Component {
    stars(icon) {
        ...
        for (let i = 0; i < totalStars; i++) {
            ...
            stars.push(createElement(Icon, { key: 'star-' + i, style: starStyles }));
        }
        return stars;
    }
    render() {
        ...
        const label = sprintf(__('%1$s out of %2$s stars.', 'woocommerce'), rating, totalStars);
        return (createElement("div", { className: classes, "aria-label": label },
            this.stars(icon),
            createElement("div", { className: "woocommerce-rating__star-outline", style: outlineStyles }, this.stars(outlineIcon || icon))));
    }
}
Rating.propTypes = {
    /**
