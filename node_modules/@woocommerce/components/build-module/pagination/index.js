...
class Pagination extends Component {
    ...
    renderPageArrows() {
        ...
        return (createElement("div", { className: "woocommerce-pagination__page-arrows" },
            showPageArrowsLabel && (createElement("span", { className: "woocommerce-pagination__page-arrows-label", role: "status", "aria-live": "polite" }, sprintf(__('Page %d of %d', 'woocommerce'), page, this.pageCount))),
            createElement("div", { className: "woocommerce-pagination__page-arrows-buttons" },
                createElement(Button, { className: previousLinkClass, disabled: !(page > 1), onClick: this.previousPage, label: __('Previous Page', 'woocommerce') },
                    createElement(Icon, { icon: chevronLeft })),
                createElement(Button, { className: nextLinkClass, disabled: !(page < this.pageCount), onClick: this.nextPage, label: __('Next Page', 'woocommerce') },
    ...
    renderPagePicker() {
        ...
        return (createElement("div", { className: "woocommerce-pagination__page-picker" },
            createElement("label", { htmlFor: instanceId, className: "woocommerce-pagination__page-picker-label" },
                __('Go to page', 'woocommerce'),
                createElement("input", { id: instanceId, className: inputClass, "aria-invalid": isError, type: "number", onClick: this.selectInputValue, onChange: this.onInputChange, onBlur: this.onInputBlur, value: inputValue, min: 1, max: this.pageCount }))));
    }
    renderPerPagePicker() {
        ...
        return (createElement("div", { className: "woocommerce-pagination__per-page-picker" },
            createElement(SelectControl, { label: __('Rows per page', 'woocommerce'), labelPosition: "side", value: this.props.perPage, onChange: this.perPageChange, options: pickerOptions })));
    }
    render() {
        ...
        if (this.pageCount <= 1) {
            return ((total > PER_PAGE_OPTIONS[0] && (createElement("div", { className: classes }, this.renderPerPagePicker()))) ||
                null);
        }
