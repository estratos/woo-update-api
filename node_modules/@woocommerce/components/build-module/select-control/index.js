...
export class SelectControl extends Component {
    constructor(props) {
        ...
        this.state = {
            ...initialState,
            searchOptions: [],
            selectedIndex: selected && (options === null || options === void 0 ? void 0 : options.length) && !excludeSelectedOptions
    ...
    announce(searchOptions) {
        ...
        if (!!searchOptions.length) {
            debouncedSpeak(sprintf(_n('%d result found, use up and down arrow keys to navigate.', '%d results found, use up and down arrow keys to navigate.', searchOptions.length, 'woocommerce'), searchOptions.length), 'assertive');
        }
        else {
