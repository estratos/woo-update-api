...
class Control extends Component {
    ...
    renderButton() {
        ...
        return (createElement("div", { className: "woocommerce-select-control__control-value" }, selected[0].label));
    }
    renderInput() {
    ...
    render() {
        const { className, disabled, hasTags, help, inlineTags, instanceId, isSearchable, label, query, } = this.props;
        const { isActive } = this.state;
        return (
        ...
        createElement("div", { className: classnames('components-base-control', 'woocommerce-select-control__control', className, {
            ...
            isSearchable && (createElement(Icon, { className: "woocommerce-select-control__control-icon", icon: search })),
            inlineTags && createElement(Tags, { ...this.props }),
            createElement("div", { className: "components-base-control__field" },
                !!label && (createElement("label", { htmlFor: `woocommerce-select-control-${instanceId}__control-input`, className: "components-base-control__label" }, label)),
                this.renderInput(),
                inlineTags && (createElement("span", { id: `search-inline-input-${instanceId}`, className: "screen-reader-text" }, __('Move backward for selected items', 'woocommerce'))),
                !!help && (createElement("p", { id: `woocommerce-select-control-${instanceId}__help`, className: "components-base-control__help" }, help))))
