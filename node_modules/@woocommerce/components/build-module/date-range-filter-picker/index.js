...
class DateRangeFilterPicker extends Component {
    ...
    getButtonLabel() {
        ...
        return [
            ...
            `${__('vs.', 'woocommerce')} ${secondaryDate.label} (${secondaryDate.range})`,
        ];
    }
