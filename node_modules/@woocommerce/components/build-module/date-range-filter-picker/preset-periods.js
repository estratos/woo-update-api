...
class PresetPeriods extends Component {
    render() {
        ...
        return (createElement(SegmentedSelection, { options: filter(presetValues, (preset) => preset.value !== 'custom'), selected: period, onSelect: onSelect, name: "period", legend: __('select a preset period', 'woocommerce') }));
    }
}
