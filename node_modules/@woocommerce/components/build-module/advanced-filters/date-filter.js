...
class DateFilter extends Component {
    ...
    getBetweenString() {
        return _x('{{after /}}{{span}} and {{/span}}{{before /}}', 'Date range inputs arranged on a single line', 'woocommerce');
    }
    ...
    render() {
        ...
        const children = interpolateComponents({
            ...
            components: {
                ...
                rule: (createElement(SelectControl, { className: classnames(className, 'woocommerce-filters-advanced__rule'), options: rules, value: rule, onChange: this.onRuleChange, "aria-label": labels.rule })),
