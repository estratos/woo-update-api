...
const AdvancedFilterItem = (props) => {
    ...
    return (createElement("li", { className: "woocommerce-filters-advanced__list-item" },
        createElement(FilterComponent, { className: "woocommerce-filters-advanced__fieldset-item", currency: currency, filter: filterValue, config: filterConfig, onFilterChange: onFilterChange, isEnglish: isEnglish, query: query }),
        createElement(Button, { className: classnames('woocommerce-filters-advanced__line-item', 'woocommerce-filters-advanced__remove'), label: labels.remove, onClick: removeFilter },
