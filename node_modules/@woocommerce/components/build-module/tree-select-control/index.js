 ...
 */
const TreeSelectControl = ({ id, label, selectAllLabel = __('All', 'woocommerce'), help, placeholder, className, disabled, options = [], value = [], maxVisibleTags, onChange = () => { }, onDropdownVisibilityChange = noop, }) => {
    ...
    createElement("div", { ...focusOutside, onKeyDown: onKeyDown, className: classnames('woocommerce-tree-select-control', className) },
        !!label && (createElement("label", { htmlFor: `woocommerce-tree-select-control-${instanceId}__control-input`, className: "woocommerce-tree-select-control__label" }, label)),
        ...
        showTree && (createElement("div", { ref: dropdownRef, className: "woocommerce-tree-select-control__tree", role: "tree", tabIndex: "-1" },
        ...
        help && (createElement("div", { className: "woocommerce-tree-select-control__help" }, help))));
};
