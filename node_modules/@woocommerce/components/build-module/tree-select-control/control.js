 ...
 */
const Control = forwardRef(({ tags = [], instanceId, placeholder, isExpanded, disabled, maxVisibleTags, value = '', onFocus = () => { }, onTagsChange = () => { }, onInputChange = () => { }, onControlClick = noop, }, ref) => {
    ...
    createElement("div", { className: classnames('components-base-control', 'woocommerce-tree-select-control__control', {
