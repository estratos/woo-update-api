...
class ReportFilters extends Component {
    ...
    renderCard(config) {
        ...
        if (query[param].indexOf('compare') === 0) {
            ...
            return (createElement("div", { key: param, className: "woocommerce-filters__advanced-filters" },
    ...
    render() {
        ...
        return (createElement(Fragment, null,
            createElement(H, { className: "screen-reader-text" }, __('Filters', 'woocommerce')),
            createElement(Section, { component: "div", className: "woocommerce-filters" },
                createElement("div", { className: "woocommerce-filters__basic-filters" },
