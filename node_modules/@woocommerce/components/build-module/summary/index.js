...
const SummaryList = ({ children, isDropdownBreakpoint, label }) => {
    ...
    return (createElement(Dropdown, { className: "woocommerce-summary", position: "bottom", headerTitle: label, renderToggle: ({ isOpen, onToggle }) => cloneElement(selected, { onToggle, isOpen }), renderContent: (renderContentArgs) => (createElement(Menu, { label: label, orientation: orientation, itemCount: itemCount, items: children(renderContentArgs) })) }));
};
