...
class SectionHeader extends Component {
    render() {
        ...
        return (createElement("div", { className: className },
            createElement(H, { className: "woocommerce-section-header__title woocommerce-section-header__header-item" }, title),
            createElement("hr", { role: "presentation" }),
            children && (createElement("div", { className: "woocommerce-section-header__actions woocommerce-section-header__header-item" }, children)),
            menu && (createElement("div", { className: "woocommerce-section-header__menu woocommerce-section-header__header-item" }, menu))));
    }
}
