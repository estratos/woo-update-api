...
class Chart extends Component {
    ...
    renderIntervalSelector() {
        ...
        return (createElement("div", { className: "woocommerce-chart__interval-select" },
    ...
    render() {
        ...
        return (createElement("div", { className: "woocommerce-chart" },
            showHeaderControls && (createElement("div", { className: "woocommerce-chart__header" },
                createElement(H, { className: "woocommerce-chart__title" }, title),
                legendPosition === 'top' && legend,
                this.renderIntervalSelector(),
                createElement(NavigableMenu, { className: "woocommerce-chart__types", orientation: "horizontal", role: "menubar" },
                    createElement(Button, { className: classNames('woocommerce-chart__type-button', {
                            'woocommerce-chart__type-button-selected': chartType === 'line',
                        }), title: __('Line chart', 'woocommerce'), "aria-checked": chartType === 'line', role: "menuitemradio", tabIndex: chartType === 'line' ? 0 : -1, onClick: partial(this.handleTypeToggle, 'line') },
                        createElement(LineGraphIcon, null)),
                    createElement(Button, { className: classNames('woocommerce-chart__type-button', {
                            'woocommerce-chart__type-button-selected': chartType === 'bar',
                        }), title: __('Bar chart', 'woocommerce'), "aria-checked": chartType === 'bar', role: "menuitemradio", tabIndex: chartType === 'bar' ? 0 : -1, onClick: partial(this.handleTypeToggle, 'bar') },
                        createElement(StatsAltIcon, null))))),
            createElement(Section, { component: false },
                createElement("div", { className: classNames('woocommerce-chart__body', `woocommerce-chart__body-${chartDirection}`), ref: this.chartBodyRef },
                    legendPosition === 'side' && legend,
                    isRequesting && (createElement(Fragment, null,
                        createElement("span", { className: "screen-reader-text" }, __('Your requested data is loading', 'woocommerce')),
                ...
                legendPosition === 'bottom' && (createElement("div", { className: "woocommerce-chart__footer" }, legend)))));
    }
}
Chart.propTypes = {
    /**
