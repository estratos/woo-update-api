 ...
 */
export const getXScale = (uniqueDates, width, compact = false) => d3ScaleBand()
    .domain(uniqueDates)
    .range([0, width])
 ...
 */
export const getXGroupScale = (orderedKeys, xScale, compact = false) => d3ScaleBand()
 ...
 */
export const getXLineScale = (uniqueDates, width) => d3ScaleTime()
    .domain([
 ...
 */
export const getYScale = (height, yMin, yMax) => d3ScaleLinear()
    .domain([
    Math.min(yMin, 0),
