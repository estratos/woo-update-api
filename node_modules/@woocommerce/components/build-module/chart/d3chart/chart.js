...
class D3Chart extends Component {
    ...
    render() {
        ...
        return (createElement("div", { className: classNames('d3-chart__container', className), style: { height } },
            this.getEmptyMessage(),
            createElement("div", { className: "d3-chart__tooltip", ref: this.tooltipRef }),
            createElement(D3Base, { className: classNames(className), data: data, drawChart: this.drawChart, height: height, orderedKeys: orderedKeys, tooltip: this.tooltip, chartType: chartType, width: computedWidth })));
    }
}
D3Chart.propTypes = {
    /**
