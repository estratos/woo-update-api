...
const defaultMessages = {
    ...
    _n('%d item selected', '%d items selected', n, 'woocommerce'), n),
...
export const SearchListControl = (props) => {
    ...
    const renderListSection = () => {
        if (isLoading) {
            return (createElement("div", { className: "woocommerce-search-list__list is-loading" },
                createElement(Spinner, null)));
        }
        const list = getFilteredList(props.list, searchValue);
        if (!list.length) {
            return (createElement("div", { className: "woocommerce-search-list__list is-not-found" },
                createElement("span", { className: "woocommerce-search-list__not-found-icon" },
                    createElement(NoticeOutlineIcon, { role: "img", "aria-hidden": "true", focusable: "false" })),
                createElement("span", { className: "woocommerce-search-list__not-found-text" }, searchValue
                    ? // eslint-disable-next-line @wordpress/valid-sprintf
                        sprintf(messages.noResults, searchValue)
                    : messages.noItems)));
        }
        return (createElement("ul", { className: "woocommerce-search-list__list" }, renderList(list)));
    };
    const renderSelectedSection = () => {
        ...
        return (createElement("div", { className: "woocommerce-search-list__selected" },
            createElement("div", { className: "woocommerce-search-list__selected-header" },
                createElement("strong", null, messages.selected(selectedCount)),
                selectedCount > 0 ? (createElement(Button, { isLink: true, isDestructive: true, onClick: onChange([]), "aria-label": messages.clear }, __('Clear all', 'woocommerce'))) : null),
    ...
    return (createElement("div", { className: classnames('woocommerce-search-list', className, {
            'is-compact': isCompact,
        }) },
        renderSelectedSection(),
        createElement("div", { className: "woocommerce-search-list__search" },
