...
class EmptyContent extends Component {
    renderIllustration() {
        ...
        return (createElement("img", { alt: "", src: illustration, width: illustrationWidth, height: illustrationHeight, className: "woocommerce-empty-content__illustration" }));
    }
    renderActionButtons(type) {
        ...
        if (actionURL && actionCallback) {
            return (createElement(Button, { className: "woocommerce-empty-content__action", isPrimary: isPrimary, onClick: actionCallback, href: actionURL }, actionLabel));
        }
        else if (actionURL) {
            return (createElement(Button, { className: "woocommerce-empty-content__action", isPrimary: isPrimary, href: actionURL }, actionLabel));
        }
        else if (actionCallback) {
            return (createElement(Button, { className: "woocommerce-empty-content__action", isPrimary: isPrimary, onClick: actionCallback }, actionLabel));
        }
        return null;
    }
    renderActions() {
        const { actionLabel, secondaryActionLabel } = this.props;
        return (createElement("div", { className: "woocommerce-empty-content__actions" },
    ...
    render() {
        ...
        return (createElement("div", { className: classnames('woocommerce-empty-content', className) },
            illustration && this.renderIllustration(),
            title ? (createElement(H, { className: "woocommerce-empty-content__title" }, title)) : null,
            message ? (createElement("p", { className: "woocommerce-empty-content__message" }, message)) : null,
            this.renderActions()));
    }
}
