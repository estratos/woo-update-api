...
class DateRange extends Component {
    ...
    render() {
        ...
        return (createElement("div", { className: classnames('woocommerce-calendar', {
                'is-mobile': isViewportMobile,
            }) },
            createElement("div", { className: "woocommerce-calendar__inputs" },
                createElement(DateInput, { value: afterText, onChange: partial(this.onInputChange, 'after'), dateFormat: shortDateFormat, label: __('Start Date', 'woocommerce'), error: afterError, describedBy: sprintf(__("Date input describing a selected date range's start date in format %s", 'woocommerce'), shortDateFormat), onFocus: () => this.onFocusChange('startDate') }),
                createElement("div", { className: "woocommerce-calendar__inputs-to" }, __('to', 'woocommerce')),
                createElement(DateInput, { value: beforeText, onChange: partial(this.onInputChange, 'before'), dateFormat: shortDateFormat, label: __('End Date', 'woocommerce'), error: beforeError, describedBy: sprintf(__("Date input describing a selected date range's end date in format %s", 'woocommerce'), shortDateFormat), onFocus: () => this.onFocusChange('endDate') })),
            createElement("div", { className: "woocommerce-calendar__react-dates", ref: this.nodeRef, onBlur: partial(this.keepFocusInside, CONTAINER_DIV), tabIndex: -1 },
