...
export default {
    ...
    focusStartDate: __('Interact with the calendar and select start and end dates.', 'woocommerce'),
    ...
    moveFocusByOneDay: __('Move backward (left) and forward (right) by one day.', 'woocommerce'),
    moveFocusByOneWeek: __('Move backward (up) and forward (down) by one week.', 'woocommerce'),
    moveFocusByOneMonth: __('Switch months.', 'woocommerce'),
    moveFocustoStartAndEndOfWeek: __('Go to the first or last day of a week.', 'woocommerce'),
    returnFocusToInput: __('Return to the date input field.', 'woocommerce'),
    keyboardNavigationInstructions: __('Press the down arrow key to interact with the calendar and select a date.', 'woocommerce'),
    chooseAvailableStartDate: ({ date }) => sprintf(__('Select %s as a start date.', 'woocommerce'), date),
    chooseAvailableEndDate: ({ date }) => sprintf(__('Select %s as an end date.', 'woocommerce'), date),
    chooseAvailableDate: ({ date }) => date,
    dateIsUnavailable: ({ date }) => sprintf(__('%s is not selectable.', 'woocommerce'), date),
    dateIsSelected: ({ date }) => sprintf(__('Selected. %s', 'woocommerce'), date),
};
