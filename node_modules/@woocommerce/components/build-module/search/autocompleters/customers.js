...
export default {
    ...
    getFreeTextOptions(query) {
        const label = (createElement("span", { key: "name", className: "woocommerce-search__result-name" }, interpolateComponents({
            mixedString: __('All customers with names that include {{query /}}', 'woocommerce'),
            components: {
    ...
    getOptionLabel(customer, query) {
        ...
        return (createElement("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": customer.name },
