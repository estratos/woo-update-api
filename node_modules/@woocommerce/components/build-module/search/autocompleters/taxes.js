...
export default {
    ...
    getFreeTextOptions(query) {
        const label = (createElement("span", { key: "name", className: "woocommerce-search__result-name" }, interpolateComponents({
            mixedString: __('All taxes with codes that include {{query /}}', 'woocommerce'),
            components: {
    ...
    getOptionLabel(tax, query) {
        ...
        return (createElement("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": tax.code },
