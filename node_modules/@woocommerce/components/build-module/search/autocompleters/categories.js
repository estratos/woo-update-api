...
export default {
    ...
    getFreeTextOptions(query) {
        const label = (createElement("span", { key: "name", className: "woocommerce-search__result-name" }, interpolateComponents({
            mixedString: __('All categories with titles that include {{query /}}', 'woocommerce'),
            components: {
    ...
    getOptionLabel(cat, query) {
        ...
        return (createElement("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": cat.name },
