...
export default {
    ...
    getFreeTextOptions(query) {
        const label = (createElement("span", { key: "name", className: "woocommerce-search__result-name" }, interpolateComponents({
            mixedString: __('All attributes with names that include {{query /}}', 'woocommerce'),
            components: {
    ...
    getOptionLabel(attribute, query) {
        ...
        return (createElement("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": attribute.name },
