...
export default {
    ...
    getFreeTextOptions(query) {
        const label = (createElement("span", { key: "name", className: "woocommerce-search__result-name" }, interpolateComponents({
            mixedString: __('All coupons with codes that include {{query /}}', 'woocommerce'),
            components: {
    ...
    getOptionLabel(coupon, query) {
        ...
        return (createElement("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": coupon.code },
