...
export default {
    ...
    getFreeTextOptions(query) {
        const label = (createElement("span", { key: "name", className: "woocommerce-search__result-name" }, interpolateComponents({
            mixedString: __('All products with titles that include {{query /}}', 'woocommerce'),
            components: {
    ...
    getOptionLabel(product, query) {
        ...
        return (createElement(Fragment, null,
            createElement(ProductImage, { key: "thumbnail", className: "woocommerce-search__result-thumbnail", product: product, width: 18, height: 18, alt: "" }),
            createElement("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": product.name },
