...
export default {
    ...
    getOptionLabel(country, query) {
        ...
        return (createElement(Fragment, null,
            createElement(Flag, { key: "thumbnail", className: "woocommerce-search__result-thumbnail", code: country.code, size: 18, hideFromScreenReader: true }),
            createElement("span", { key: "name", className: "woocommerce-search__result-name", "aria-label": name }, query ? (createElement(Fragment, null,
