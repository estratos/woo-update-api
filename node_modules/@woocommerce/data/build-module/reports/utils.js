...
import { flattenFilters, getActiveFiltersFromQuery, getQueryFromActiveFilters, } from '@woocommerce/navigation';
 ...
 */
const getReportChartDataResponse = memoize((requestString, totals, intervals) => ({
    isEmpty: false,
    isError: false,
    isRequesting: false,
