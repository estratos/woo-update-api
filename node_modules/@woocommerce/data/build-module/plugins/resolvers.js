...
import { setIsRequesting, updateActivePlugins, setError, updateInstalledPlugins, updateIsJetpackConnected, updateJetpackConnectUrl, setPaypalOnboardingStatus, setRecommendedPlugins, } from './actions';
...
function* setOnboardingStatusWithOptions() {
    const options = yield resolveSelect(OPTIONS_STORE_NAME, 'getOption', 'woocommerce-ppcp-settings');
