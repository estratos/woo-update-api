...
export declare type ItemType = 'categories' | 'products' | 'customers' | 'leaderboards';
export declare type ItemImage = {
    id: number;
    date_created: string;
...
export declare type Item = Partial<CategoryItem | ProductItem | CustomerItem | LeaderboardItem> & {
    id: ItemID;
};
export declare type ItemInfer<T> = Partial<T extends 'categories' ? CategoryItem : T extends 'products' ? ProductItem : T extends 'customers' ? CustomerItem : T extends 'leaderboards' ? LeaderboardItem : never> & {
    id: ItemID;
};
export declare type ItemsState = {
    items: Record<string, {
        data: ItemID[];
...
export declare type Query = Partial<BaseQueryParams>;
export {};
