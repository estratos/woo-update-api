...
const ImageComponent = _ref => {
  ...
  const [shouldUseFallback, setShouldUseFallback] = (0, _element.useState)(false);
  const {
    height: windowHeight,
    width: windowWidth
  } = (0, _reactNative.useWindowDimensions)();
  const isLandscape = (0, _element.useRef)(windowWidth > windowHeight);
  ...
  (0, _element.useEffect)(() => {
    if (_element.Platform.isAndroid && shouldUseFastImage) {
