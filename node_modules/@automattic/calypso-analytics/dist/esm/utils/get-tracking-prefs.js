...
export const parseTrackingPrefs = (cookieV2, cookieV1, defaultPrefs = prefsDisallowAll) => {
 ...
 */
export default function getTrackingPrefs() {
    ...
    const { ok, buckets } = parseTrackingPrefs(cookies[TRACKING_PREFS_COOKIE_V2], cookies[TRACKING_PREFS_COOKIE_V1], defaultPrefs);
    if (isCountryCcpa) {
