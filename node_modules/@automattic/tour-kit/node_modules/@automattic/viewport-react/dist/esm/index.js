import { isWithinBreakpoint, subscribeIsWithinBreakpoint, MOBILE_BREAKPOINT, DESKTOP_BREAKPOINT } from '@automattic/viewport';
 ...
 * wrapped component.
 */
export const withBreakpoint = breakpoint => createHigherOrderComponent(WrappedComponent => /*#__PURE__*/forwardRef((props, ref) => {
 ...
 */
export const withMobileBreakpoint = createHigherOrderComponent(WrappedComponent => /*#__PURE__*/forwardRef((props, ref) => {
 ...
 * @returns {Function} The wrapped component.
 */
export const withDesktopBreakpoint = createHigherOrderComponent(WrappedComponent => /*#__PURE__*/forwardRef((props, ref) => {
