...
function useScaleGradient(backupColor) {
    return (0, react_1.useCallback)((u, scaleKey, ori, scaleStops, discrete = false) => {
...
exports.default = useScaleGradient;
//# sourceMappingURL=use-scale-gradient.js.map