...
const quadtree_1 = tslib_1.__importStar(require("../lib/quadtree"));
 ...
 */
function seriesBarsPlugin(opts, spaceBetween = 1) {
    ...
    function walkTwo(yIdx, xCount, yCount, xDim, xDraw, yDraw) {
        (0, quadtree_1.distr)(xCount, groupWidth, groupDistr, null, (ix, offPct, dimPct) => {
            const groupOffPx = xDim * offPct;
            const groupWidPx = xDim * dimPct;
            xDraw && xDraw(ix, groupOffPx, groupWidPx);
            yDraw &&
                (0, quadtree_1.distr)(yCount, barWidth, barDistr, yIdx, (iy, offPct, dimPct) => {
    ...
    function drawBars(u, sidx, i0, i1) {
        return uplot_1.default.orient(u, sidx, (series, dataX, dataY, scaleX, scaleY, valToPosX, valToPosY, xOff, yOff, xDim, yDim, moveTo, lineTo, rect) => {
    ...
    function drawPoints(u, sidx, i0, i1) {
        ...
        uplot_1.default.orient(u, sidx, (series, dataX, dataY, scaleX, scaleY, valToPosX, valToPosY, xOff, yOff, xDim, yDim, moveTo, lineTo, rect) => {
    ...
    function range(u, dataMin, dataMax) {
        const [min, max] = uplot_1.default.rangeNum(0, dataMax, 0.05, true);
        return [0, max];
    }
    let qt;
    let hovered = null;
    ...
    return {
        hooks: {
            ...
            drawClear: (u) => {
                qt = qt || new quadtree_1.default(0, 0, u.bbox.width, u.bbox.height, null);
                qt.clear();
        ...
        opts: (u, opts) => {
            ...
            uplot_1.default.assign(opts.axes?.[0] || {}, {
                splits: (u, axisIdx) => {
                    const dim = ori === 0 ? u.bbox.width : u.bbox.height;
                    const _dir = dir * (ori === 0 ? 1 : -1);
                    const splits = [];
                    (0, quadtree_1.distr)(u.data?.[1]?.length, groupWidth, groupDistr, null, (di, lftPct, widPct) => {
...
exports.default = seriesBarsPlugin;
//# sourceMappingURL=multi-bars.js.map