...
export default function UplotChart({ data, mainColor = '#3057DC', fillColorFrom = 'rgba(48, 87, 220, 0.4)', fillColorTo = 'rgba(48, 87, 220, 0)', yAxisFilter = undefined, legendContainer, options: propOptions, solidFill = false, period, }) {
    ...
    return (_jsx("div", { className: "calypso-uplot-chart-container", ref: uplotContainer, children: _jsx(UplotReact, { data: data, onCreate: (chart) => (uplot.current = chart), options: options }) }));
}
