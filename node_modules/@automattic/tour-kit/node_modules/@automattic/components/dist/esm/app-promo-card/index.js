...
export default function AppPromoCard({ className, isWoo, clickHandler }) {
    ...
    const getMessage = () => {
        ...
        if (isWoo) {
            return translate('Visit {{a}}woo.com/mobile{{/a}} or scan the QR code to download the WooCommerce mobile app.', {
                components: {
                    a: (_jsx("a", { className: "app-promo-card__link app-promo-card__woo-link", href: getRedirectUrl('wooA8C') ?? 'https://woo.com/mobile', onClick: () => onClickHandler(CLICK_EVENTS.wooClickA8C) })),
                },
            });
        }
        return translate('Visit {{a}}wp.com/app{{/a}} or scan the QR code to download the Jetpack mobile app.', {
            components: {
                a: (_jsx("a", { className: "app-promo-card__link app-promo-card__jetpack-link", href: localizeUrl('https://apps.wordpress.com/get/?campaign=calypso-stats-promo'), onClick: () => onClickHandler(CLICK_EVENTS.jetpackClickA8C) })),
            },
        });
    };
    ...
    const getPromoImage = () => {
        ...
        if (isApple) {
            ...
            return (_jsx("a", { href: appStoreLink ?? fallbackLink, onClick: () => onClickHandler(tracksEventName), children: _jsx("img", { className: "app-promo-card__store-badge", src: storeBadgeApple, alt: "Badge for the Apple App Store" }) }));
        }
        if (isGoogle) {
            ...
            return (_jsx("a", { href: appStoreLink ?? fallbackLink, onClick: () => onClickHandler(tracksEventName), children: _jsx("img", { className: "app-promo-card__store-badge", src: storeBadgeGoogle, alt: "Badge for the Google Play Store" }) }));
        }
        return isWoo ? (_jsx("img", { className: "app-promo-card__qr-code", src: qrCodeWoo, alt: "QR Code for Woo mobile app" })) : (_jsx(QRCode, { className: "app-promo-card__qr-code", value: localizeUrl('https://apps.wordpress.com/get/?campaign=calypso-qrcode-apps'), size: 300 }));
    };
    return (_jsxs("div", { className: clsx('app-promo-card', className ?? null), children: [_jsxs("div", { className: "app-promo-card__lhs", children: [_jsxs("div", { className: "app-promo-card__icons", children: [isWoo && (_jsx("img", { className: "app-promo-card__woo-icon", src: iconWoo, alt: "Icon for the Woo mobile app" })), !isWoo && _jsx(WordPressJetpackSVG, {})] }), _jsx("p", { className: "app-promo-card__title", children: isWoo
                            ? translate('Bring your Store stats with you using the Woo mobile app')
                            : translate('Bring your stats with you using the Jetpack mobile app') }), _jsx("p", { className: "app-promo-card__message", children: getMessage() })] }), _jsx("div", { className: "app-promo-card__rhs", children: getPromoImage() })] }));
}
