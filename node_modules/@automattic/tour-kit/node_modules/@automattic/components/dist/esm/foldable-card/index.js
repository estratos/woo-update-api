...
class FoldableCard extends Component {
    ...
    renderActionButton() {
        ...
        if (this.props.children) {
            ...
            return (_jsxs("button", { disabled: this.props.disabled, type: "button", className: "foldable-card__action foldable-card__expand", "aria-expanded": this.state.expanded, onClick: clickAction, children: [_jsx(ScreenReaderText, { children: screenReaderText }), _jsx(Gridicon, { icon: this.props.icon, size: this.props.iconSize })] }));
        }
    }
    renderContent() {
        ...
        return (_jsx("div", { className: "foldable-card__content", style: additionalStyle, children: this.props.children }));
    }
    renderHeader() {
