...
export const DEFAULT_LOCALE = (typeof window === 'undefined' ? null : window.navigator?.language) ?? 'en-US';
// Preset Options
...
export default function formatNumber(number, locale = DEFAULT_LOCALE, options = DEFAULT_OPTIONS) {
