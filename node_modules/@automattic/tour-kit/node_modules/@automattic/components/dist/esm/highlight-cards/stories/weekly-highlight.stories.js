...
const Template = ({ showValueTooltip, ...args }) => {
    ...
    return (_jsx("div", { style: { position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }, children: _jsx(WeeklyCards, { counts: counts, previousCounts: previousCounts, onClickComments: handleClick, onClickLikes: handleClick, onClickViews: handleClick, onClickVisitors: handleClick, showValueTooltip: showValueTooltip }) }));
};
...
//# sourceMappingURL=weekly-highlight.stories.js.map