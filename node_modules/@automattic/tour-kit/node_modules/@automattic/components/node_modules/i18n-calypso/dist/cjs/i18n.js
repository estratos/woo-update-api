...
var _interpolateComponents = _interopRequireDefault(require("@automattic/interpolate-components"));
var _sprintf = _interopRequireDefault(require("@tannin/sprintf"));
var _debug = _interopRequireDefault(require("debug"));
var _ = _interopRequireDefault(require("hash.js/lib/hash/sha/1"));
var _lru = _interopRequireDefault(require("lru"));
var _tannin = _interopRequireDefault(require("tannin"));
var _numberFormat = _interopRequireDefault(require("./number-format"));
/**
 * Module variables
 */
const debug = (0, _debug.default)('i18n-calypso');
...
function I18N() {
  ...
  this.state = {
    ...
    translations: (0, _lru.default)({
      max: 100
    })
  };
  this.componentUpdateHooks = [];
  this.translateHooks = [];
  this.stateObserver = new _events.EventEmitter();
...
I18N.prototype.numberFormat = function (number, options = {}) {
  ...
  return (0, _numberFormat.default)(number, decimals, decPoint, thousandsSep);
};
...
I18N.prototype.setLocale = function (localeData) {
  if (localeData && localeData[''] && localeData['']['key-hash']) {
    ...
    const transform = function (string, hashLength) {
      ...
      const hash = (0, _.default)().update(string).digest('hex');
      if (hashLength) {
  ...
  this.state.tannin = new _tannin.default({
...
I18N.prototype.translate = function () {
  ...
  if (options.args) {
    ...
    try {
      translation = (0, _sprintf.default)(...sprintfArgs);
    } catch (error) {
  ...
  if (options.components) {
    translation = (0, _interpolateComponents.default)({
