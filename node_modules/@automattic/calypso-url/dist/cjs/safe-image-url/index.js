...
exports.safeImageUrl = void 0;
const tslib_1 = require("tslib");
const photon_1 = tslib_1.__importDefault(require("photon"));
const url_parts_1 = require("../url-parts");
/**
...
function safeImageUrl(url) {
    ...
    const parsedUrl = (0, url_parts_1.getUrlParts)(url);
    if (REGEXP_A8C_HOST.test(parsedUrl.hostname)) {
        // Safely promote Automattic domains to HTTPS
        parsedUrl.protocol = 'https';
        return (0, url_parts_1.getUrlFromParts)(parsedUrl).toString();
    }
    ...
    if (parsedUrl.search && (parsedUrl.host || parsedUrl.hostname || parsedUrl.origin)) {
        ...
        url = (0, url_parts_1.getUrlFromParts)(parsedUrl).toString();
    }
    // Photon doesn't support SVGs
    if (parsedUrl.pathname.endsWith('.svg')) {
        return null;
    }
    return (0, photon_1.default)(url);
}
