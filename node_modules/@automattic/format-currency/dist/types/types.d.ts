export interface CurrencyFormatter {
    ...
    formatCurrency: (amount: number, currencyCode: string, options?: CurrencyObjectOptions) => string;
    getCurrencyObject: (amount: number, currencyCode: string, options?: CurrencyObjectOptions) => CurrencyObject;
}
