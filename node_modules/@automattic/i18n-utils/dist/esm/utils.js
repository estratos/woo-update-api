 ...
 */
export function translationExists(phrase) {
 ...
 */
export function getMappedLanguageSlug(langSlug) {
 ...
 * @returns original path with new locale slug
 */
export function addLocaleToPathLocaleInFront(path, locale) {
 ...
 * @returns original path minus locale slug
 */
export function removeLocaleFromPathLocaleInFront(path) {
    // Remove the first '/'.
    path = path.slice(1);
    const urlParts = getUrlParts(path);
    const queryString = urlParts.search || '';
 ...
 * @returns locale
 */
export function retrieveLocaleFromPathLocaleInFront(path) {
    // Remove the first '/'.
    path = path.slice(1);
    const urlParts = getUrlParts(path);
    const parts = getPathParts(urlParts.pathname);
