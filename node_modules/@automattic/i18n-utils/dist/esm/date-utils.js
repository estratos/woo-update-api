 ...
 */
export const getRelativeTimeString = ({ timestamp, locale = 'en', now = Date.now(), style = 'narrow', }) => {
 ...
 */
export const getISODateString = (timestamp) => {
 ...
 */
export const getShortDateString = (timestamp, locale = 'en') => {
    try {
 ...
 *   Falls back to ISO date string if anything goes wrong.
 */
export const getNumericDateString = (timestamp, locale = 'en') => {
    try {
        const formatter = new Intl.DateTimeFormat(locale, {
            year: 'numeric',
            month: 'numeric',
